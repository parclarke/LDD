...
### 4.3c Reports: nothing to migrate
...
|---|---|---|
| `DATATABLEEDITORREPORT` | 15 | Pega's auto-generated "edit this data table" grid, one per data table |
...
All carry `pzIsAutoGenerated`. There are **zero** hand-built reports, so there is
no reporting requirement to elicit and nothing to port. Model-driven Dataverse
views and Power BI replace this category outright.
