...
table(s,
      ...
      [["*Human assignments", "Dataverse rows + Code App UI", "Implemented"],
       ...
       ["*Notifications (17)", "Outbox table + Power Automate flow",
        "*Queued by the app; flow sends"],
...
table(s,
      ...
      [["*Notification delivery", "17 steps",
        "*Content recovered 27/27 and outbox built - only recipients need deciding"],
...
table(s,
      ...
      [["*Stage transition guards are inferred", "*High",
       ...
       ["*Notification recipients undefined", "*Low",
        "Wording fully recovered - only the recipient list needs deciding"],
...
table(s,
      ...
      [["*Rework-condition workshops", "Business decision, not extraction", "4 - 6"],
       ...
       ["*Notification delivery", "Outbox built; one flow + recipient mapping", "3 - 5"],
       ...
       ["*TOTAL", "*One application of this complexity", "*77 - 120"]],
